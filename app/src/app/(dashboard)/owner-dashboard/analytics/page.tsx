...
import { BarChart3, TrendingUp, MessageSquare, ThumbsUp, ThumbsDown, Star, Award } from "lucide-react"
    ...
    <div className="p-8 space-y-8 bg-gray-50/50 min-h-screen">
      ...
      <Tabs defaultValue="feedback" className="space-y-4">
        <TabsList>
          ...
          {/* Revenue tab removed as per request to focus on feedback here */}
        </TabsList>
            ...
            <Card>
                ...
                <CardContent>
                    <div className="space-y-4">
                        {[
                            { user: "Ali", text: "The Nasi Lemak was amazing! Best on campus.", sentiment: "Positive" },
                            { user: "Sarah", text: "Coffee was a bit cold today.", sentiment: "Negative" },
                            { user: "John", text: "Good portion size for the price.", sentiment: "Positive" },
                        ].map((review, i) => (
                            <div key={i} className="flex items-start justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">"{review.text}"</p>
                                </div>
